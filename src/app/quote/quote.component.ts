...
export class QuoteComponent implements OnInit {
  quotes: Quote[] = [
    new Quote(1, 'Gideon Makori', "“Education is the most powerful weapon which you can use to change the world if you are planning for a lifetime, educate people............", new Date(2021, 1, 20)),
    ...
    new Quote(4, 'Breen Mkaka', "“The first step toward success is taken when you refuse to be a captive of the environment in which you first find yourself.” ", new Date(2021, 2, 15)),
  ];
